...
#define SPACE_PORTAL_NORMAL_TO_FLAPPY_DOWN 50
#define SPACE_PORTAL_NORMAL_TO_FLAPPY_UP 51
#define SPACE_PORTAL_FLAPPY_TO_NORMAL_UP 52
#define SPACE_PORTAL_FLAPPY_TO_NORMAL_DOWN 53
